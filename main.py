...
def guitar_positions(args: argparse.Namespace):
    ...
    if args.notes:
        ...
        positions_all = music.get_all_guitar_positions_for_chord_name(
            ...
            guitar=guitar,
            max_fret_span=args.max_fret_span,
    ...
    tuning_display = (
        guitar.tuning_name
        if guitar.tuning_name == "standard"
        else f"{guitar.tuning_name} ({guitar}):"
    )
    print(
...
if __name__ == "__main__":
    ...
    guitar_positions_parser.add_argument(
        "--name", type=str, help="A chord name, like Bbmaj7/D; will return all possible voicings"
    )
    guitar_positions_parser.add_argument(
    ...
    guitar_positions_parser.add_argument(
        ...
        "-f",
        type=int,
        default=music.DEFAULT_MAX_FRET_SPAN,
    ...
    guitar_positions_parser.add_argument(
        "--tuning",
        type=music.Guitar.parse_tuning,
        default=None,
    ...
    guitar_positions_parser.add_argument(
        "--frets", type=int, default=music.Guitar.DEFAULT_FRETS, help="How many frets on the guitar"
    )
    guitar_positions_parser.add_argument(
